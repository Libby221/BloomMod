...
{
    public class IndianasWhipProjectile : ModProjectile
    {
        ...
        {
            target.AddBuff(ModContent.BuffType<IndianasWhipDebuff>(), 240);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                Rectangle frame = new Rectangle(0, 0, 10, 22); // The size of the Handle (measured in pixels)
                Vector2 origin = new Vector2(5, 2); // Offset for where the player's hand will start measured from the top left of the image.
                float scale = 1;
